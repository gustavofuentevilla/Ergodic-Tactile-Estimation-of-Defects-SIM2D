...
for i = 1:n_iter
    ...
    for j = 1:n_def
        ...
        Phi_hat_x_j(:,j) = prod([reshape(Phi_hat_x_1_next_grid,[],1),...
            reshape(Phi_hat_x_2_next_grid,[],1)], 2);
    end
...
for i = 1:n_iter
    ...
    plot(X_e_reg(1,1,i), X_e_reg(1,2,i),'ksq','MarkerSize',8,'LineWidth',2)
    for j = 1:n_def
        plot(Elipse_Phi(:,1,j), Elipse_Phi(:,2,j), "-.k", "LineWidth", 1.5)
    end
