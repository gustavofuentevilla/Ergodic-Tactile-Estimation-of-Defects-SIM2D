function [Priors, Mu, Sigma] = GMM_EM(Data, K, Prev_Priors, Prev_Mu, Prev_Sigma, iteration, Opts)
%
...
% (see the commented code for a version involving one-by-one computation,
