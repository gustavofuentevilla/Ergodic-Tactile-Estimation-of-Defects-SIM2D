...
load(sprintf("/home/gustavo-fuentevilla/MATLAB/"...
    ...
    + "Test2/Case1/%dDef/X0_%d/output_%d.mat",...
...
% t_exec = (0:T_s_interp:T_s-T_s_interp)';
t_exec = [];
...
% t_0 = [t_exec(1); t_exec(end)];
% x_e_sp = spline(t_0, X_e(:,1), t_exec);
% y_e_sp = spline(t_0, X_e(:,2), t_exec);
% 
...
save(sprintf("/home/gustavo-fuentevilla/MATLAB/"...
    ...
    + "Exploration_of_Defects/2. GMM_approach/"...
    + "2. Tactile_Exp_GMM_Appr_ndef_unknown/"...
    + "BO_Approach/BO_consTest/Test2/Case1/%dDef/X0_%d/output_%d.mat",...
