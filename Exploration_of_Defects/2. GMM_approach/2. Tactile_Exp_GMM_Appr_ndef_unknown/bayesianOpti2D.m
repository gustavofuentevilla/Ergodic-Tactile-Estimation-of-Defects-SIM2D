...
close all; clear; clc; angle = [45 45]; 
Nstart = 2;    % Initial no. of observations
obs = 50;       % No. of more observations to perform
...
for t = 1:height(x), y_true(t) = f(x(t,:)); end     % Sample the func at x
